...
class CharacterForm(FlaskForm):
    ...
    gold_pieces = IntegerField('gold pieces', validators=[NumberRange(min=0, max=10000)])
    silver_pieces = IntegerField('silver pieces', validators=[NumberRange(min=0, max=10000)])
    copper_pieces = IntegerField('copper pieces', validators=[NumberRange(min=0, max=10000)])
